...
////	@JsonIgnore
////	@ManyToOne
////	@JoinColumn(name = "product_id", nullable = false, foreignKey=@ForeignKey(name="ref_product"))
...
////	@JsonIgnore
////	@ManyToOne
////	@JoinColumn(name = "customer_id", nullable = false, foreignKey=@ForeignKey(name="ref_customer"))
...
//	}
//
////	public DealHistory(Long id, Date dealHistoryDate, String dealHistoryDesc, Product product, Customer customer) {
////		super();
////		this.id = id;
